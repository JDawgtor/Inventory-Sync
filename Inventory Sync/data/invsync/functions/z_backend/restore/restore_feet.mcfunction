...
# $item replace entity @s armor.feet with $(Item) $(Count)
# # item modify entity @s armor.feet invsync:nbt
...
item replace entity @s armor.feet from entity @e[type=armor_stand,limit=1,sort=nearest,tag=item_transfer] weapon.mainhand
