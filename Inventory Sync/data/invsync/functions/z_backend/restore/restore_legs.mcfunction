...
# $item replace entity @s armor.legs with $(Item) $(Count)
# # item modify entity @s armor.legs invsync:nbt
...
item replace entity @s armor.legs from entity @e[type=armor_stand,limit=1,sort=nearest,tag=item_transfer] weapon.mainhand
