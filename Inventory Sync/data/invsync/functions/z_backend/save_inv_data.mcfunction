##This will create a new storage named player(UID) (e.g player1), then depending on which gamemode, save Inventory data to a new custom tag of Inventory(gamemode) (e.g Inventory1 = Gamemode 1)
