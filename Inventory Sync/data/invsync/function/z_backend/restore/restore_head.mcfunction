...
# $item replace entity @s armor.head with $(Item) $(Count)
# # item modify entity @s armor.head invsync:nbt
...
item replace entity @s armor.head from entity @e[type=armor_stand,limit=1,sort=nearest,tag=item_transfer] weapon.mainhand
